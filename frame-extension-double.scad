...
module frame_extension_double_horizontal() {
  pyramid_box_truss(frame_back_width, frame_extend_height*2, frame_back_depth,
          ...
          box_bolt_pattern_side(frame_back_width, frame_extend_height*2, frame_back_depth, 5,
                                 frame_extend_truss_xy_thickness, 2, 6, false);
          box_bolt_pattern_side(frame_back_width, frame_extend_height*2, frame_back_depth, 5,
                                 frame_extend_truss_xy_thickness, 2, 6, true);
}
